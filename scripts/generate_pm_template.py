...
def generate_standard_pm_template():
    ...
    rows = [
        ...
        ["Session 01", "Orientation", "ORIENTATION", "Session 01 - Định hướng khóa học & Lộ trình môn học", "Lesson 01: Tổng quan lộ trình và Demo sản phẩm", "1. Tổng quan nội dung & Lộ trình môn học (Timeline/List) | 2. Phương pháp học tập hiệu quả & Kiến thức tiền đề (AI Pair-Programming) | 3. Demo sản phẩm dự án đầu ra (Capstone Spec)", "Nắm vững tổng quan lộ trình môn học, áp dụng phương pháp học tập kết hợp AI IDE và hiểu rõ tiêu chuẩn sản phẩm đầu ra.", "CẤM: Gõ lệnh CLI, cài đặt phần mềm, viết mã nguồn, tạo code demo hay sandbox rỗng.", "ĐÃ HỌC: Chưa có (Buổi mở đầu).", "Python 3.12, VS Code"],
