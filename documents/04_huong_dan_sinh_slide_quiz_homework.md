# TÀI LIỆU HƯỚNG DẪN 04: BƯỚC 3 - SINH SLIDE DECK, QUIZ EXCEL VÀ BÀI TẬP VỀ NHÀ

## 1. Mục Đích
Tự động hóa sản xuất các tài nguyên phụ trợ giảng dạy hoàn chỉnh: Slide bài giảng PowerPoint (`.pptx`) và HTML, Bộ Quiz trắc nghiệm 45 câu Excel, Bộ 17 bài tập về nhà phân tầng theo thang Bloom có rubric chấm điểm, và Sơ đồ tư duy Mindmap.

---

## 2. Slide Bài Giảng PowerPoint và HTML (`Slide bài giảng/`)
...
- Tuân thủ nghiêm ngặt nguyên tắc **3-30-300 Typography** (tối đa 3 ý/slide, 30 chữ/ý, font size >= 18px), Card Color Coding hiện đại, Bento Grid, và không chứa emoji.
- Tự động sinh file **`outline_bai_giang.md`** hỗ trợ giảng viên lên lớp với kịch bản chi tiết và phân bổ thời gian.
- Xuất file **`slide_deck_review_report.md`** đánh giá kiểm định chất lượng slide.

---

## 3. Bộ Quiz Đầu Giờ và Cuối Giờ (45 Câu Excel `.xlsx`)
...
## 4. Bộ Bài Tập Về Nhà 17 Thư Mục và Rubric Chấm Điểm (`Bài tập/`)
...
- **17 Thư mục bài tập**:
  - `1_van_dung_co_ban_1_...` đến `6_van_dung_co_ban_6_...`: Bài tập sửa lỗi cú pháp và logic (Debugging).
...
## 5. Sơ Đồ Tư Duy Mindmap (`Mindmap/session_mindmap.md`)
