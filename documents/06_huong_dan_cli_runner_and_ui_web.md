# 🛠️ TÀI LIỆU HƯỚNG DẪN 06: HƯỚNG DẪN SỬ DỤNG LỆNH CLI & CÔNG CỤ VẬN HÀNH (ĐÃ KIỂM CHỨNG)
...
## 1. 📋 Kiểm Tra Trạng Thái & Cấu Hình Hệ Thống

### 1.1. Xem Trợ Giúp & Danh Sách Tùy Chọn CLI
```bash
python main.py --help
```
...
### 1.3. Kiểm Tra Cấu Hình Centralized Settings & Secrets
```bash
...
### 2.2. Sinh Toàn Bộ Khóa Học (All Sessions)
```bash
...
# Chỉ sinh Bài tập & Bộ Quiz trắc nghiệm 45 câu:
...
### 2.5. Khởi Tạo Nhanh Cây Thư Mục Cấu Trúc (Scaffolding Mode)
...
## 3. 📦 Lệnh Đóng Gói Xuất Bản (Export LMS & Obsidian Vault)
...
## 4. 🧪 Lệnh Kiểm Thử & Chẩn Đoán Lõi (Testing & Core Verification)
...
```bash
# Kiểm thử Quản lý Cấu hình & Bảo mật:
