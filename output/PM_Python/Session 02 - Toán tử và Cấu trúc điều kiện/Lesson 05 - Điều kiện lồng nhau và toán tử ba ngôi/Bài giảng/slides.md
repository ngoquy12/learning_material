...
<head>
  ...
  <title>Điều kiện lồng nhau và toán tử ba ngôi — Rikkei Master Slide Presentation</title>
...
<body>
  ...
  <div id="main-stage">
    ...
    <div class="slide slide-cover active" data-type="cover" data-title="Điều kiện lồng nhau và toán tử ba ngôi">
      ...
      <div class="cover-content-box">
        ...
        <div class="cover-main-title">Điều kiện lồng nhau và toán tử ba ngôi</div>
...
<div class="agenda-item-row"><span>2.</span> <span>Nested If-Else (Cấu trúc điều kiện lồng nhau)</span></div>
<div class="agenda-item-row"><span>3.</span> <span>Ternary Operator (Toán tử ba ngôi)</span></div>
<div class="agenda-item-row"><span>4.</span> <span>Tiêu chuẩn PEP 8 cho câu lệnh điều kiện</span></div>
<div class="agenda-item-row"><span>5.</span> <span>Đánh giá ngắn mạch (Short-circuit Evaluation)</span></div>
<div class="agenda-item-row"><span>6.</span> <span>Luồng Dữ Liệu & Kiến Trúc</span></div>
      ...
      <div class="content-header-title">
        ...
        <div class="cards-container-row">
          <div class="card-column-box">
            ...
            <div class="inner-white-card"><h4>Trở Ngại Hệ Thống #1</h4><p>- **Bài toán thực tế doanh nghiệp**:</p></div>
<div class="inner-white-card"><h4>Trở Ngại Hệ Thống #2</h4><p>- Trong một hệ thống bán lẻ trực tuyến, việc tính toán mức chiết khấu tối ưu cho hóa đơn khách hàng dựa trên nhiều biến số độc lập như thứ hạng thành viên, giá trị giỏ hàng và thời gian khuyến mãi</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Giải Pháp & Cách Khắc Phục</div>
            <div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #1</h4><p>- Ban đầu, lập trình viên sử dụng các khối điều kiện lồng nhau liên tiếp (**Nested if-else**), tạo ra một cấu trúc mã nguồn dạng hình chóp ngược hay còn gọi là **Arrow Anti-pattern**</p></div>
<div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #2</h4><p>- Cấu trúc này làm giảm nghiêm trọng khả năng đọc hiểu, tăng chi phí bảo trì và dễ bỏ sót các trường hợp biên của kiểm thử dẫn đến thất thoát doanh thu doanh nghiệp</p></div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="02. Bản Chất Kỹ Thuật: Nested If-Else (Cấu trúc điều kiện lồng...">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        02. Bản Chất Kỹ Thuật: Nested If-Else (Cấu trúc điều kiện lồng...
      </div>
        ...
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            ...
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Kỹ thuật đặt một hoặc nhiều câu lệnh điều kiện (if, elif, else) bên trong một khối điều kiện khác, nhằm giải quyết các tình huống rẽ nhánh đa cấp phức tạp khi một quyết định phụ thuộc vào kết quả của quyết định trước đó</p></div>
                ...
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Nested If-Else (Cấu trúc điều kiện lồng nhau)' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
                ...
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Nested If-Else (Cấu trúc điều kiện lồng nhau)' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              age = 20<br/>is_student = True<br/><br/><span class="cm"># Kịch bản kiểm tra độ tuổi và trạng thái thẻ học sinh để áp dụng giá vé</span><br/>if age &lt; 18:<br/>    ticket_price = 50000<br/>else:<br/>    if is_student:<br/>        ticket_price = 70000<br/>    else:<br/>        ticket_price = 100000<br/><br/>print('Gia ve: ' + str(ticket_price) + ' VND')
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="03. Bản Chất Kỹ Thuật: Ternary Operator (Toán tử ba ngôi)">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        03. Bản Chất Kỹ Thuật: Ternary Operator (Toán tử ba ngôi)
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Cấu trúc biểu thức điều kiện viết gọn trên một dòng trong Python với cú pháp: `gia_tri_dung if dieu_kien else gia_tri_sai`</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Nó giúp mã nguồn ngắn gọn hơn khi thực hiện gán giá trị hoặc trả về kết quả đơn giản</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Ternary Operator (Toán tử ba ngôi)' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Ternary Operator (Toán tử ba ngôi)' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              score = 75<br/><br/><span class="cm"># Su dung toan tu ba ngoi de phan loai nhanh ket qua</span><br/>status = 'Dat' if score &gt;= 50 else 'Khong dat'<br/><br/>print('Trang thai hoc vien:', status)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="04. Bản Chất Kỹ Thuật: Tiêu chuẩn PEP 8 cho câu lệnh điều kiện">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        04. Bản Chất Kỹ Thuật: Tiêu chuẩn PEP 8 cho câu lệnh điều kiện
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Quy tắc thiết kế mã nguồn chuẩn Python khuyến nghị giữ cho biểu thức điều kiện rõ ràng, tránh lồng ghép quá sâu (deep nesting) làm giảm khả năng đọc hiểu, và không so sánh trực tiếp boolean (ví dụ: dùng `if is_valid:` thay vì `if is_valid == True:`)</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Tiêu chuẩn PEP 8 cho câu lệnh điều kiện' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Tiêu chuẩn PEP 8 cho câu lệnh điều kiện' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Cach viet khong toi uu, lam thu dong code dai dong</span><br/>is_active = True<br/>age = 20<br/><br/><span class="cm"># Cach viet toi uu tuan thu PEP 8 (khong so sanh == True, gop dieu kien logic)</span><br/>can_vote = is_active and age &gt;= 18<br/>print('Quyen bau cu:', can_vote)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="05. Bản Chất Kỹ Thuật: Đánh giá ngắn mạch (Short-circuit...">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        05. Bản Chất Kỹ Thuật: Đánh giá ngắn mạch (Short-circuit...
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Cơ chế tối ưu hóa của Python khi xử lý các toán tử logic (and, or)</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Quá trình đánh giá sẽ dừng lại và trả về kết quả ngay khi biểu thức đủ điều kiện để xác định giá trị cuối cùng mà không cần chạy tất cả các mệnh đề còn lại</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Đánh giá ngắn mạch (Short-circuit Evaluation)' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Đánh giá ngắn mạch (Short-circuit Evaluation)' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              income = 15000000<br/>credit_score = 650<br/><br/><span class="cm"># He thong phan loai duyet han muc tin dung dua tren thu nhap va diem tin dung</span><br/>if income &gt;= 20000000:<br/>    loan_status = 'Phe duyet cao' if credit_score &gt;= 700 else 'Phe duyet trung binh'<br/>elif income &gt;= 10000000:<br/>    if credit_score &gt;= 600:<br/>        loan_status = 'Phe duyet tieu chuan'<br/>    else:<br/>        loan_status = 'Yeu cau tai san bao dam'<br/>else:<br/>    loan_status = 'Tu choi ho so'<br/><br/>print('Ket qua duyet ho so:', loan_status)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="06. Phân Tích Luồng Dữ Liệu & Nguyên Lý Vận Hành">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        06. Phân Tích Luồng Dữ Liệu & Nguyên Lý Vận Hành
      </div>
...
flowchart TD
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="07. Cảnh Báo Bẫy Cú Pháp & Anti-Pattern Thường Gặp">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        07. Cảnh Báo Bẫy Cú Pháp & Anti-Pattern Thường Gặp
      </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="08. Tổng Kết Trọng Tâm & Tiến Trình Cột Mốc Bài Học">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        08. Tổng Kết Trọng Tâm & Tiến Trình Cột Mốc Bài Học
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-red);">Tổng Kết Kiến Thức</div>
            <div class="inner-white-card"><h4>Điểm Cốt Lõi #1</h4><p>- **Tóm tắt bài học**:</p></div>
<div class="inner-white-card"><h4>Điểm Cốt Lõi #2</h4><p>- Cấu trúc rẽ nhánh lồng nhau quá sâu làm suy giảm nghiêm trọng chất lượng mã nguồn và tăng nguy cơ gây lỗi logic thụt lề</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Sai Lầm Cần Tránh</div>
            <div class="inner-white-card"><h4>Lưu Ý Thực Chiến #1</h4><p>- Sử dụng toán tử ba ngôi giúp rút gọn việc gán giá trị có điều kiện về dạng biểu thức dòng đơn tiện lợi</p></div>
<div class="inner-white-card"><h4>Lưu Ý Thực Chiến #2</h4><p>- Kỹ thuật điều kiện bảo vệ (**Guard Clauses**) là phương pháp tối ưu chính giúp làm phẳng luồng xử lý mã và nâng cao hiệu suất đọc mã nguồn</p></div>
        ...
        <div class="timeline-nodes-grid">
          ...
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              ...
              <p>- **Bài toán thực tế doanh nghiệp**:
  - Trong một hệ thống bán lẻ trực tuyến, việc tính t...</p>
            </div>
          ...
          <div class="timeline-node">
            ...
            <div class="node-card" style="margin-top: 24px;">
              <h5>2. Nested If-Else (Cấu trúc điều kiện...</h5>
              <p>Kỹ thuật đặt một hoặc nhiều câu lệnh điều kiện (if, elif, else) bên trong một khối điều ki...</p>
            </div>
          </div>
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              <h5>3. Ternary Operator (Toán tử ba ngôi)</h5>
              <p>Cấu trúc biểu thức điều kiện viết gọn trên một dòng trong Python với cú pháp: `gia_tri_dun...</p>
            </div>
            <div class="timeline-dot"></div>
          </div>
          <div class="timeline-node">
            <div class="timeline-dot" style="margin-top: 60px;"></div>
            <div class="node-card" style="margin-top: 24px;">
              <h5>4. Tiêu chuẩn PEP 8 cho câu lệnh điều...</h5>
              <p>Quy tắc thiết kế mã nguồn chuẩn Python khuyến nghị giữ cho biểu thức điều kiện rõ ràng, tr...</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="controls">
      ...
      <span id="slide-indicator">1 / 11</span>
