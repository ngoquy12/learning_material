...
<head>
  ...
  <title>Toán tử so sánh — Rikkei Master Slide Presentation</title>
...
<body>
  ...
  <div id="main-stage">
    ...
    <div class="slide slide-cover active" data-type="cover" data-title="Toán tử so sánh">
      ...
      <div class="cover-content-box">
        ...
        <div class="cover-main-title">Toán tử so sánh</div>
...
<div class="agenda-item-row"><span>2.</span> <span>Kieu Du Lieu Boolean</span></div>
<div class="agenda-item-row"><span>3.</span> <span>Toan Tu So Sanh</span></div>
<div class="agenda-item-row"><span>4.</span> <span>Phan Biet Gan và So Sanh Bang</span></div>
<div class="agenda-item-row"><span>5.</span> <span>Ep Kieu Du Lieu</span></div>
<div class="agenda-item-row"><span>6.</span> <span>Ham Input</span></div>
      ...
      <div class="content-header-title">
        ...
        <div class="cards-container-row">
          <div class="card-column-box">
            ...
            <div class="inner-white-card"><h4>Trở Ngại Hệ Thống #1</h4><p>- **Bối cảnh thực tế tại doanh nghiệp**:</p></div>
<div class="inner-white-card"><h4>Trở Ngại Hệ Thống #2</h4><p>- Trong các hệ thống phần mềm doanh nghiệp như thương mại điện tử hoặc quản lý phân sự, việc ra quyết định tự động dựa trên dữ liệu đầu vào là vô cùng quan trọng</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Giải Pháp & Cách Khắc Phục</div>
            <div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #1</h4><p>- Ví dụ: Hệ thống cần xác định một đơn hàng có được áp dụng mã giảm giá hay không dựa trên tổng giá trị đơn hàng, hoặc kiểm tra xem sản phẩm trong kho có đủ số lượng để cung cấp cho khách hàng hay không</p></div>
<div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #2</h4><p>- Nếu không có cơ chế so sánh dữ liệu, chương trình chỉ chạy tuyến tính và không thể xử lý các nghiệp vụ logic rẽ nhánh phức tạp trong thực tế kinh doanh</p></div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="02. Bản Chất Kỹ Thuật: Kieu Du Lieu Boolean">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        02. Bản Chất Kỹ Thuật: Kieu Du Lieu Boolean
      </div>
        ...
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            ...
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Kiểu dữ liệu chỉ nhận một trong hai giá trị là True (đúng) hoặc False (sai), dùng để biểu diễn tính đúng đắn của một mệnh đề hoặc điều kiện</p></div>
                ...
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Kieu Du Lieu Boolean' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
                ...
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Kieu Du Lieu Boolean' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              a = 15<br/>b = 10<br/>print(a &gt; b)   # Kết quả: True<br/>print(a &lt; b)   # Kết quả: False<br/>print(a == b)  # Kết quả: False<br/>print(a != b)  # Kết quả: True
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="03. Bản Chất Kỹ Thuật: Toan Tu So Sanh">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        03. Bản Chất Kỹ Thuật: Toan Tu So Sanh
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Các toán tử bao gồm lớn hơn (>), nhỏ hơn (<), lớn hơn hoặc bằng (>=), nhỏ hơn hoặc bằng (<=), bằng (==) và khác (!=) dùng để so sánh hai giá trị và trả về kết quả kiểu Boolean</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Toan Tu So Sanh' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Toan Tu So Sanh' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Toán tử gán (=) để đặt giá trị</span><br/>tuoi = 25<br/><br/><span class="cm"># Toán tử so sánh (==) kiểm tra sự bằng nhau</span><br/>la_tuoi_truong_thanh = (tuoi == 18)<br/>print('Có phải 18 tuổi không:', la_tuoi_truong_thanh)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="04. Bản Chất Kỹ Thuật: Phan Biet Gan và So Sanh Bang">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        04. Bản Chất Kỹ Thuật: Phan Biet Gan và So Sanh Bang
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Toán tử '=' dùng để gán giá trị cho một biến</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Toán tử '==' dùng để kiểm tra sự bằng nhau giữa hai vế, trả về kết quả True hoặc False</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Phan Biet Gan và So Sanh Bang' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Phan Biet Gan và So Sanh Bang' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Nhận dữ liệu dưới dạng chuỗi</span><br/>chuoi_nhap = input('Nhập số tuổi của bạn: ')<br/><br/><span class="cm"># Thực hiện ép kiểu sang số nguyên để chuẩn bị so sánh</span><br/>tuoi_nhap = int(chuoi_nhap)<br/><br/><span class="cm"># So sánh dữ liệu đã ép kiểu</span><br/>du_tuoi = (tuoi_nhap &gt;= 18)<br/>print('Đủ điều kiện đăng ký:', du_tuoi)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="05. Bản Chất Kỹ Thuật: Ep Kieu Du Lieu">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        05. Bản Chất Kỹ Thuật: Ep Kieu Du Lieu
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Phương pháp chuyển đổi định dạng của dữ liệu (như sử dụng int() hoặc float() để chuyển chuỗi ký tự nhập vào từ input() thành dạng số) phục vụ cho các phép toán số học hoặc so sánh</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Ep Kieu Du Lieu' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Ep Kieu Du Lieu' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Định nghĩa hằng số hệ thống theo chuẩn PEP 8</span><br/>PIN_HE_THONG = '1234'<br/><br/><span class="cm"># Lấy thông tin từ người dùng và so sánh</span><br/>pin_nhap = input('Nhập mã PIN của bạn: ')<br/>kiem_tra_pin = (pin_nhap == PIN_HE_THONG)<br/><br/><span class="cm"># Sử dụng f-string biểu diễn kết quả rõ ràng</span><br/>print(f'Kết quả xác thực: {kiem_tra_pin}')
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="06. Bản Chất Kỹ Thuật: Ham Input">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        06. Bản Chất Kỹ Thuật: Ham Input
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Hàm dựng sẵn dùng để tạm dừng chương trình và nhận dữ liệu nhập vào từ bàn phím dưới dạng một chuỗi (string)</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Ham Input' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Ham Input' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="07. Bản Chất Kỹ Thuật: Dinh Dang Chuoi F String">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        07. Bản Chất Kỹ Thuật: Dinh Dang Chuoi F String
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Cú pháp định dạng chuỗi bắt đầu bằng chữ f trước dấu nháy, cho phép nhúng trực tiếp giá trị của biến hoặc biểu thức vào chuỗi bằng cặp ngoặc nhọn {}</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Dinh Dang Chuoi F String' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Dinh Dang Chuoi F String' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="08. Bản Chất Kỹ Thuật: Chuan Pep 8">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        08. Bản Chất Kỹ Thuật: Chuan Pep 8
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Quy tắc định dạng mã nguồn Python chuẩn giúp mã nguồn dễ đọc hơn, ví dụ: chèn một dấu cách trước và sau các toán tử so sánh (x == y)</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Chuan Pep 8' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Chuan Pep 8' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
      ...
      <div class="content-header-title">
        ...
        <div class="cards-container-row">
          <div class="card-column-box">
            ...
            <div class="inner-white-card"><h4>Điểm Cốt Lõi #1</h4><p>- **Các điểm kiến thức cốt lõi**:</p></div>
<div class="inner-white-card"><h4>Điểm Cốt Lõi #2</h4><p>- Toán tử so sánh cơ bản bao gồm so sánh lớn hơn (`>`), nhỏ hơn (`<`), lớn hơn hoặc bằng (`>=`), và nhỏ hơn hoặc bằng (`<=`)</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Sai Lầm Cần Tránh</div>
            <div class="inner-white-card"><h4>Lưu Ý Thực Chiến #1</h4><p>- Toán tử kiểm tra sự tương đồng bao gồm toán tử so sánh bằng (`==`) và toán tử so sánh khác biệt (`!=`)</p></div>
<div class="inner-white-card"><h4>Lưu Ý Thực Chiến #2</h4><p>- Toàn bộ kết quả đầu ra của biểu thức so sánh luôn trả về giá trị thuộc kiểu dữ liệu `bool` (`True` hoặc `False`)</p></div>
        ...
        <div class="timeline-nodes-grid">
          ...
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              ...
              <p>- **Bối cảnh thực tế tại doanh nghiệp**:
  - Trong các hệ thống phần mềm doanh nghiệp như ...</p>
            </div>
          ...
          <div class="timeline-node">
            ...
            <div class="node-card" style="margin-top: 24px;">
              <h5>2. Kieu Du Lieu Boolean</h5>
              <p>Kiểu dữ liệu chỉ nhận một trong hai giá trị là True (đúng) hoặc False (sai), dùng để biểu ...</p>
            </div>
          </div>
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              <h5>3. Toan Tu So Sanh</h5>
              <p>Các toán tử bao gồm lớn hơn (>), nhỏ hơn (<), lớn hơn hoặc bằng (>=), nhỏ hơn hoặc bằng (<...</p>
            </div>
            <div class="timeline-dot"></div>
          </div>
          <div class="timeline-node">
            <div class="timeline-dot" style="margin-top: 60px;"></div>
            <div class="node-card" style="margin-top: 24px;">
              <h5>4. Phan Biet Gan và So Sanh Bang</h5>
              <p>Toán tử '=' dùng để gán giá trị cho một biến. Toán tử '==' dùng để kiểm tra sự bằng nhau g...</p>
            </div>
          </div>
        </div>
      </div>
