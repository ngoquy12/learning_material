...
<head>
  ...
  <title>Cấu trúc điều kiện đa nhánh if-else-match-case — Rikkei Master Slide Presentation</title>
...
<body>
  ...
  <div id="main-stage">
    ...
    <div class="slide slide-cover active" data-type="cover" data-title="Cấu trúc điều kiện đa nhánh if-else-match-case">
      ...
      <div class="cover-content-box">
        ...
        <div class="cover-main-title">Cấu trúc điều kiện đa nhánh if-else-match-case</div>
...
<div class="agenda-item-row"><span>2.</span> <span>If Elif Else</span></div>
<div class="agenda-item-row"><span>3.</span> <span>Match Case</span></div>
<div class="agenda-item-row"><span>4.</span> <span>Wildcard Pattern</span></div>
<div class="agenda-item-row"><span>5.</span> <span>Logic Error</span></div>
<div class="agenda-item-row"><span>6.</span> <span>Pep 8 Alignment</span></div>
      ...
      <div class="content-header-title">
        ...
        <div class="cards-container-row">
          <div class="card-column-box">
            ...
            <div class="inner-white-card"><h4>Trở Ngại Hệ Thống #1</h4><p>- **Đặt vấn đề trong thực tế**:</p></div>
<div class="inner-white-card"><h4>Trở Ngại Hệ Thống #2</h4><p>- Tại các doanh nghiệp phát triển hệ thống e-commerce hoặc ví điện tử, việc tính toán phí giao dịch và chiết khấu (discount) dựa trên hạng thành viên là một nghiệp vụ cốt lõi</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Giải Pháp & Cách Khắc Phục</div>
            <div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #1</h4><p>- Hệ thống cần phân loại chính xác người dùng dựa trên nhiều cấp bậc khác nhau như Bronze, Silver, Gold, Platinum, và áp dụng các chương trình ưu đãi đặc biệt tương ứng</p></div>
<div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #2</h4><p>- Khi số lượng hạng thành viên tăng lên và các điều kiện đi kèm trở nên phức tạp, việc thiết kế luồng xử lý quyết định (decision flow) gặp nhiều trở ngại về cả hiệu năng lẫn độ sạch của mã nguồn</p></div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="02. Bản Chất Kỹ Thuật: If Elif Else">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        02. Bản Chất Kỹ Thuật: If Elif Else
      </div>
        ...
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            ...
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Cấu trúc điều kiện rẽ nhánh tuần tự</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Python sẽ đánh giá các biểu thức điều kiện từ trên xuống dưới, thực thi khối mã tương ứng đầu tiên trả về giá trị True và bỏ qua tất cả các nhánh còn lại</p></div>
                ...
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'If Elif Else' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
                ...
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'If Elif Else' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              score = 85<br/><br/>if score &gt;= 90:<br/>    classification = "Xuất sắc"<br/>elif score &gt;= 80:<br/>    classification = "Giỏi"<br/>elif score &gt;= 65:<br/>    classification = "Khá"<br/>else:<br/>    classification = "Trung bình"<br/><br/>print("Xếp loại học lực:", classification)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="03. Bản Chất Kỹ Thuật: Match Case">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        03. Bản Chất Kỹ Thuật: Match Case
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Cấu trúc so khớp mẫu (Pattern Matching) được giới thiệu từ phiên bản Python 3</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Cấu trúc này cho phép so sánh một giá trị với nhiều mẫu khác nhau một cách trực quan, rõ ràng và hiệu quả hơn so với chuỗi if-elif-else phức tạp</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Match Case' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Match Case' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              status_code = 404<br/><br/>match status_code:<br/>    case 200:<br/>        message = "Thành công (OK)"<br/>    case 400:<br/>        message = "Yêu cầu không hợp lệ (Bad Request)"<br/>    case 404:<br/>        message = "Không tìm thấy trang (Not Found)"<br/>    case _:<br/>        message = "Lỗi không xác định"<br/><br/>print("Trạng thái phản hồi:", message)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="04. Bản Chất Kỹ Thuật: Wildcard Pattern">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        04. Bản Chất Kỹ Thuật: Wildcard Pattern
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Ký tự gạch dưới '_' được dùng làm mẫu đại diện mặc định (wildcard) cuối cùng trong cấu trúc match-case</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Nó sẽ khớp với bất kỳ giá trị nào nếu tất cả các trường hợp trước đó đều không khớp, tương đương với nhánh 'else'</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Wildcard Pattern' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Wildcard Pattern' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Lỗi logic cũ: Sắp xếp điều kiện lỏng lẻo lên trước (ví dụ: c &gt;= 5 trước c &gt;= 10)</span><br/><span class="cm"># Sửa lỗi: Đặt điều kiện khắt khe lên trước và căn lề đúng chuẩn PEP 8</span><br/><br/>score = 9.5<br/><br/>if score &gt;= 9.0:<br/>    grade = "A"<br/>elif score &gt;= 8.0:<br/>    grade = "B"<br/>elif score &gt;= 5.0:<br/>    grade = "C"<br/>else:<br/>    grade = "F"<br/><br/>print("Điểm chữ hợp lệ:", grade)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="05. Bản Chất Kỹ Thuật: Logic Error">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        05. Bản Chất Kỹ Thuật: Logic Error
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Lỗi xảy ra khi mã nguồn chạy thành công mà không gây ra lỗi cú pháp hay crash chương trình, nhưng kết quả đầu ra lại không chính xác</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Lỗi này thường do việc sắp xếp sai thứ tự các điều kiện hoặc thiết lập biểu thức logic sai</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Logic Error' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Logic Error' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              print("=== MENU DỊCH VỤ HỌC VIÊN ===")<br/>print("1. Đăng ký khóa học Python")<br/>print("2. Xem thông tin lớp học")<br/>print("3. Liên hệ bộ phận hỗ trợ")<br/>print("=============================")<br/><br/>choice = input("Nhập lựa chọn của bạn (1-3): ")<br/><br/>match choice:<br/>    case "1":<br/>        print("Bạn đã chọn đăng ký khóa học Python mới.")<br/>    case "2":<br/>        print("Lớp học Python Core diễn ra vào lúc 19:30 thứ 3, 5, 7 hàng tuần.")<br/>    case "3":<br/>        print("Đang kết nối tới tổng đài viên tư vấn...")<br/>    case _:<br/>        print("Lựa chọn không hợp lệ. Vui lòng khởi động lại chương trình.")
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="06. Bản Chất Kỹ Thuật: Pep 8 Alignment">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        06. Bản Chất Kỹ Thuật: Pep 8 Alignment
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Quy chuẩn định dạng mã nguồn Python giúp mã sạch và dễ đọc</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Đối với cấu trúc điều kiện, chuẩn PEP 8 yêu cầu thụt lề thống nhất 4 khoảng trắng cho mỗi khối lệnh con và đặt đúng 1 khoảng trắng quanh các toán tử so sánh (như ==, >=, <=)</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Pep 8 Alignment' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Pep 8 Alignment' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="07. Phân Tích Luồng Dữ Liệu & Nguyên Lý Vận Hành">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        07. Phân Tích Luồng Dữ Liệu & Nguyên Lý Vận Hành
      </div>
...
flowchart TD
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="08. Cảnh Báo Bẫy Cú Pháp & Anti-Pattern Thường Gặp">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        08. Cảnh Báo Bẫy Cú Pháp & Anti-Pattern Thường Gặp
      </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="09. Tổng Kết Trọng Tâm & Tiến Trình Cột Mốc Bài Học">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        09. Tổng Kết Trọng Tâm & Tiến Trình Cột Mốc Bài Học
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-red);">Tổng Kết Kiến Thức</div>
            <div class="inner-white-card"><h4>Điểm Cốt Lõi #1</h4><p>- **Khái niệm then chốt**:</p></div>
<div class="inner-white-card"><h4>Điểm Cốt Lõi #2</h4><p>- Cấu trúc `if-elif-else` phù hợp nhất cho các biểu thức logic so sánh khoảng giá trị hoặc nhiều biến số khác nhau</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Sai Lầm Cần Tránh</div>
            <div class="inner-white-card"><h4>Lưu Ý Thực Chiến #1</h4><p>- Cấu trúc `match-case` từ phiên bản Python 3</p></div>
<div class="inner-white-card"><h4>Lưu Ý Thực Chiến #2</h4><p>10 tối ưu hóa việc so khớp cấu trúc đối tượng dữ liệu cụ thể, nâng cao tính trực quan và độ sạch của code</p></div>
        ...
        <div class="timeline-nodes-grid">
          ...
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              ...
              <p>- **Đặt vấn đề trong thực tế**: 
  - Tại các doanh nghiệp phát triển hệ thống e-commerce h...</p>
            </div>
          ...
          <div class="timeline-node">
            ...
            <div class="node-card" style="margin-top: 24px;">
              <h5>2. If Elif Else</h5>
              <p>Cấu trúc điều kiện rẽ nhánh tuần tự. Python sẽ đánh giá các biểu thức điều kiện từ trên xu...</p>
            </div>
          </div>
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              <h5>3. Match Case</h5>
              <p>Cấu trúc so khớp mẫu (Pattern Matching) được giới thiệu từ phiên bản Python 3.10. Cấu trúc...</p>
            </div>
            <div class="timeline-dot"></div>
          </div>
          <div class="timeline-node">
            <div class="timeline-dot" style="margin-top: 60px;"></div>
            <div class="node-card" style="margin-top: 24px;">
              <h5>4. Wildcard Pattern</h5>
              <p>Ký tự gạch dưới '_' được dùng làm mẫu đại diện mặc định (wildcard) cuối cùng trong cấu trú...</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div id="controls">
      ...
      <span id="slide-indicator">1 / 12</span>
