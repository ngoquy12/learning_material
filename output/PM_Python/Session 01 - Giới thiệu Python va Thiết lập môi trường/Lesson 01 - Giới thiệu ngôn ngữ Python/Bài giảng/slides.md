...
<head>
  ...
  <title>Giới thiệu ngôn ngữ Python — Rikkei Master Slide Presentation</title>
...
<body>
  ...
  <div id="main-stage">
    ...
    <div class="slide slide-cover active" data-type="cover" data-title="Giới thiệu ngôn ngữ Python">
      ...
      <div class="cover-content-box">
        ...
        <div class="cover-main-title">Giới thiệu ngôn ngữ Python</div>
...
<div class="agenda-item-row"><span>2.</span> <span>Ngon ngu Python (Python Language)</span></div>
<div class="agenda-item-row"><span>3.</span> <span>Trinh thong dich Python (Interpreter)</span></div>
<div class="agenda-item-row"><span>4.</span> <span>Moi truong ao (Virtual Environment)</span></div>
<div class="agenda-item-row"><span>5.</span> <span>Ham print()</span></div>
<div class="agenda-item-row"><span>6.</span> <span>Loi cu phap (Syntax Error)</span></div>
      ...
      <div class="content-header-title">
        ...
        <div class="cards-container-row">
          <div class="card-column-box">
            ...
            <div class="inner-white-card"><h4>Trở Ngại Hệ Thống #1</h4><p>- **Bối cảnh lịch sử phát triển công nghệ thông tin**:</p></div>
<div class="inner-white-card"><h4>Trở Ngại Hệ Thống #2</h4><p>- Trong những thập niên cuối thế kỷ 20, các nhà phát triển phần mềm doanh nghiệp phụ thuộc nặng nề vào các ngôn ngữ biên dịch cấp thấp như **C** và **C++**</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Giải Pháp & Cách Khắc Phục</div>
            <div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #1</h4><p>- Mặc dù mang lại hiệu năng tối ưu, các ngôn ngữ này đòi hỏi người viết mã nguồn phải quản lý trực tiếp bộ nhớ hệ thống, xử lý chi tiết con trỏ và thực hiện các chu trình phân bổ phức tạp</p></div>
<div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #2</h4><p>- Một lỗi nhỏ trong việc thu hồi bộ nhớ có thể dẫn đến rò rỉ dữ liệu hoặc làm sập toàn bộ hệ điều hành của doanh nghiệp</p></div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="02. Bản Chất Kỹ Thuật: Ngon ngu Python (Python Language)">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        02. Bản Chất Kỹ Thuật: Ngon ngu Python (Python Language)
      </div>
        ...
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            ...
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Ngon ngu lap trinh bac cao, thong dich, huong doi tuong va da muc dich, duoc phat trien boi Guido van Rossum nam 1991</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Python noi bat voi cu phap ro rang, de doc va co kho thu vien phong phu cho nhieu linh vuc</p></div>
                ...
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Ngon ngu Python (Python Language)' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
                ...
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Ngon ngu Python (Python Language)' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Chuong trinh Python dau tien</span><br/>print("Hello, World!")
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="03. Bản Chất Kỹ Thuật: Trinh thong dich Python (Interpreter)">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        03. Bản Chất Kỹ Thuật: Trinh thong dich Python (Interpreter)
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Chuong trinh thuc thi cho phep doc truc tiep tung dong ma nguon Python, phan tich va chay chung ma khong can quan buoc phai bien dich toan bo chuong trinh sang file ma may nhi phan (</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Trinh thong dich Python (Interpreter)' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Trinh thong dich Python (Interpreter)' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Huong dan su dung Terminal/Command Prompt de cau hinh moi truong ao</span><br/><span class="cm"># </span><br/><span class="cm"># Buoc 1: Tao moi truong ao dat ten la 'venv'</span><br/><span class="cm"># Lenh execute: python -m venv venv</span><br/><span class="cm">#</span><br/><span class="cm"># Buoc 2: Kich hoat moi truong ao</span><br/><span class="cm"># Tren Windows (PowerShell): .\\venv\\Scripts\\Activate.ps1</span><br/><span class="cm"># Tren Windows (CMD): .\\venv\\Scripts\\activate.bat</span><br/><span class="cm"># Tren macOS/Linux: source venv/bin/activate</span>
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="04. Bản Chất Kỹ Thuật: Moi truong ao (Virtual Environment)">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        04. Bản Chất Kỹ Thuật: Moi truong ao (Virtual Environment)
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Mot thu muc rieng biet chua phien ban Python va cac thu vien can thiet cho mot du an rieng le</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Viec dung moi truong ao giup co lap va tranh xung dot phien ban thu vien khi phat trien nhieu du an tren mot may tinh</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Moi truong ao (Virtual Environment)' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Moi truong ao (Virtual Environment)' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Vi du ve loi cu phap va cach sua</span><br/><span class="cm"># </span><br/><span class="cm"># Code loi (Thieu dau nhay kep ket thuc chuoi):</span><br/><span class="cm"># print("Hello World)</span><br/><span class="cm"># </span><br/><span class="cm"># Code dung:</span><br/>print("Hello World")
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="05. Bản Chất Kỹ Thuật: Ham print()">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        05. Bản Chất Kỹ Thuật: Ham print()
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Ham co san cua he thong dung de xuat cac thong tin duoi dang chuoi ky tu ra man hinh console de kiem tra hoac giao tiep voi nguoi dung</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Ham print()' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Ham print()' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="06. Bản Chất Kỹ Thuật: Loi cu phap (Syntax Error)">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        06. Bản Chất Kỹ Thuật: Loi cu phap (Syntax Error)
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Loi xay ra khi doan code viet sai quy tac ngu phap cua ngon ngu</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Khi gap loi nay, trinh thong dich Python se thong bao vi tri loi va khien chuong trinh ngung hoat dong ngay lap tuc</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Loi cu phap (Syntax Error)' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Loi cu phap (Syntax Error)' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
      ...
      <div class="content-header-title">
        ...
        <div class="cards-container-row">
          <div class="card-column-box">
            ...
            <div class="inner-white-card"><h4>Điểm Cốt Lõi #1</h4><p>- **Lưu ý quan trọng khi bắt đầu viết mã Python**:</p></div>
<div class="inner-white-card"><h4>Điểm Cốt Lõi #2</h4><p>- Python phân biệt chữ hoa và chữ thường trong khai báo danh tính (Ví dụ: Biến `User` khác hoàn toàn với biến `user`)</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Sai Lầm Cần Tránh</div>
            <div class="inner-white-card"><h4>Lưu Ý Thực Chiến #1</h4><p>- Lập trình viên bắt buộc phải sử dụng 4 dấu cách (Space) để lùi dòng thụt lề nhằm định nghĩa khối lệnh trong các cấu trúc phức tạp</p></div>
<div class="inner-white-card"><h4>Lưu Ý Thực Chiến #2</h4><p>- **Cảnh báo các sai lầm runtime thường gặp**:</p></div>
        ...
        <div class="timeline-nodes-grid">
          ...
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              ...
              <p>- **Bối cảnh lịch sử phát triển công nghệ thông tin**:
  - Trong những thập niên cuối thế ...</p>
            </div>
          ...
          <div class="timeline-node">
            ...
            <div class="node-card" style="margin-top: 24px;">
              <h5>2. Ngon ngu Python (Python Language)</h5>
              <p>Ngon ngu lap trinh bac cao, thong dich, huong doi tuong va da muc dich, duoc phat trien bo...</p>
            </div>
          </div>
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              <h5>3. Trinh thong dich Python...</h5>
              <p>Chuong trinh thuc thi cho phep doc truc tiep tung dong ma nguon Python, phan tich va chay ...</p>
            </div>
            <div class="timeline-dot"></div>
          </div>
          <div class="timeline-node">
            <div class="timeline-dot" style="margin-top: 60px;"></div>
            <div class="node-card" style="margin-top: 24px;">
              <h5>4. Moi truong ao (Virtual Environment)</h5>
              <p>Mot thu muc rieng biet chua phien ban Python va cac thu vien can thiet cho mot du an rieng...</p>
            </div>
          </div>
        </div>
      </div>
