...
<head>
  ...
  <title>Khai báo Biến — Rikkei Master Slide Presentation</title>
...
<body>
  ...
  <div id="main-stage">
    ...
    <div class="slide slide-cover active" data-type="cover" data-title="Khai báo Biến">
      ...
      <div class="cover-content-box">
        ...
        <div class="cover-main-title">Khai báo Biến</div>
...
<div class="agenda-item-row"><span>2.</span> <span>Biến (Variable)</span></div>
<div class="agenda-item-row"><span>3.</span> <span>Quy tắc đặt tên biến theo chuẩn PEP 8</span></div>
<div class="agenda-item-row"><span>4.</span> <span>SyntaxError trong khai báo biến</span></div>
<div class="agenda-item-row"><span>5.</span> <span>NameError</span></div>
<div class="agenda-item-row"><span>6.</span> <span>Cập nhật giá trị biến</span></div>
      ...
      <div class="content-header-title">
        ...
        <div class="cards-container-row">
          <div class="card-column-box">
            ...
            <div class="inner-white-card"><h4>Trở Ngại Hệ Thống #1</h4><p>- Trực quan hóa dữ liệu trong thực tế:</p></div>
<div class="inner-white-card"><h4>Trở Ngại Hệ Thống #2</h4><p>- Trong lập trình ứng dụng doanh nghiệp, hệ thống cần xử lý và lưu trữ tạm thời một lượng lớn thông tin biến động như số lượng hàng tồn kho, đơn giá sản phẩm hoặc thông tin tài khoản người dùng</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Giải Pháp & Cách Khắc Phục</div>
            <div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #1</h4><p>- Ở cấp độ phần cứng, máy tính quản lý và truy xuất thông tin dựa vào các địa chỉ vật lý thô của bộ nhớ RAM dưới dạng các chuỗi thập lục phân phức tạp</p></div>
<div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #2</h4><p>- Những thách thức nếu không có cơ chế quản lý phù hợp:</p></div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="02. Bản Chất Kỹ Thuật: Biến (Variable)">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        02. Bản Chất Kỹ Thuật: Biến (Variable)
      </div>
        ...
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            ...
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Một vùng trong bộ nhớ máy tính được đặt tên dùng để lưu trữ dữ liệu</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Giá trị của biến có thể thay đổi và cập nhật trong quá trình thực thi chương trình</p></div>
                ...
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Biến (Variable)' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
                ...
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Biến (Variable)' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Khai báo biến đúng chuẩn PEP 8 (snake_case)</span><br/>student_name = "Nguyen Van A"<br/>math_score = 9.5<br/>is_passed = True<br/><br/><span class="cm"># Cac truong hop khai bao sai quy tac (gay loi SyntaxError)</span><br/><span class="cm"># 1st_student = "B"      # Loi vi bat dau bang so</span><br/><span class="cm"># total-amount = 1000   # Loi vi chua dau gach ngang</span><br/><span class="cm"># class = "Python Core"  # Loi vi trung tu khoa he thong</span>
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="03. Bản Chất Kỹ Thuật: Quy tắc đặt tên biến theo chuẩn PEP 8">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        03. Bản Chất Kỹ Thuật: Quy tắc đặt tên biến theo chuẩn PEP 8
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Quy chuẩn định dạng mã nguồn Python khuyến nghị đặt tên biến bằng chữ thường, các từ phân cách bằng dấu gạch dưới (snake_case) (ví dụ: user_age, total_score), không bắt đầu bằng chữ số và không trùng với các từ khóa hệ thống (keyword)</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Quy tắc đặt tên biến theo chuẩn PEP 8' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Quy tắc đặt tên biến theo chuẩn PEP 8' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Minh hoa ve loi NameError do sai chinh ta</span><br/>user_age = 18<br/><span class="cm"># print(user_eg)  # Gây ra loi NameError: name 'user_eg' is not defined</span><br/><br/><span class="cm"># Minh hoa ve loi SyntaxError do su dung ky tu dac biet</span><br/><span class="cm"># user$name = "Admin"  # Gây ra loi SyntaxError: invalid syntax</span>
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="04. Bản Chất Kỹ Thuật: SyntaxError trong khai báo biến">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        04. Bản Chất Kỹ Thuật: SyntaxError trong khai báo biến
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Lỗi cú pháp xảy ra khi chương trình viết sai quy tắc của ngôn ngữ Python, ví dụ như đặt tên biến chứa khoảng trắng, chứa ký tự đặc biệt trái phép hoặc bắt đầu bằng số</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'SyntaxError trong khai báo biến' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'SyntaxError trong khai báo biến' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Khoi tao so luong sach trong kho</span><br/>book_count = 100<br/>print("So luong ban dau:", book_count)<br/><br/><span class="cm"># Cap nhat gia tri bien bang cach gán gia tri moi truc tiep</span><br/>book_count = 85<br/>print("So luong sau khi ban:", book_count)<br/><br/><span class="cm"># Cap nhat tang dan bang bieu thuc toan hoc</span><br/>book_count = book_count + 50<br/>print("So luong sau khi nhap them:", book_count)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="05. Bản Chất Kỹ Thuật: NameError">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        05. Bản Chất Kỹ Thuật: NameError
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Lỗi định danh xảy ra khi cố gắng gọi hoặc sử dụng một biến chưa được khai báo trước đó trong chương trình, hoặc do gõ sai chính tả tên biến khi truy xuất</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'NameError' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'NameError' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="06. Bản Chất Kỹ Thuật: Cập nhật giá trị biến">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        06. Bản Chất Kỹ Thuật: Cập nhật giá trị biến
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Hành động thay đổi dữ liệu mà biến đang tham chiếu tới bằng cách sử dụng toán tử gán (=) để gán một giá trị mới cho biến đã được khai báo trước đó</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Cập nhật giá trị biến' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Cập nhật giá trị biến' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
      ...
      <div class="content-header-title">
        ...
        <div class="cards-container-row">
          <div class="card-column-box">
            ...
            <div class="inner-white-card"><h4>Điểm Cốt Lõi #1</h4><p>- Tóm tắt nguyên lý cốt lõi:</p></div>
<div class="inner-white-card"><h4>Điểm Cốt Lõi #2</h4><p>- Biến trong Python là các nhãn tham chiếu đến đối tượng trong bộ nhớ, được quản lý theo cơ chế định kiểu động</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Sai Lầm Cần Tránh</div>
            <div class="inner-white-card"><h4>Lưu Ý Thực Chiến #1</h4><p>- Phong cách đặt tên biến bắt buộc phải tuần thủ quy chuẩn ký tự đặc biệt của bộ dịch và nên áp dụng phong cách viết `snake_case` của PEP 8</p></div>
        ...
        <div class="timeline-nodes-grid">
          ...
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              ...
              <p>- Trực quan hóa dữ liệu trong thực tế:
  - Trong lập trình ứng dụng doanh nghiệp, hệ thống...</p>
            </div>
          ...
          <div class="timeline-node">
            ...
            <div class="node-card" style="margin-top: 24px;">
              <h5>2. Biến (Variable)</h5>
              <p>Một vùng trong bộ nhớ máy tính được đặt tên dùng để lưu trữ dữ liệu. Giá trị của biến có t...</p>
            </div>
          </div>
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              <h5>3. Quy tắc đặt tên biến theo chuẩn PEP...</h5>
              <p>Quy chuẩn định dạng mã nguồn Python khuyến nghị đặt tên biến bằng chữ thường, các từ phân ...</p>
            </div>
            <div class="timeline-dot"></div>
          </div>
          <div class="timeline-node">
            <div class="timeline-dot" style="margin-top: 60px;"></div>
            <div class="node-card" style="margin-top: 24px;">
              <h5>4. SyntaxError trong khai báo biến</h5>
              <p>Lỗi cú pháp xảy ra khi chương trình viết sai quy tắc của ngôn ngữ Python, ví dụ như đặt tê...</p>
            </div>
          </div>
        </div>
      </div>
