...
<head>
  ...
  <title>Nhập, xuất dữ liệu trong python — Rikkei Master Slide Presentation</title>
...
<body>
  ...
  <div id="main-stage">
    ...
    <div class="slide slide-cover active" data-type="cover" data-title="Nhập, xuất dữ liệu trong python">
      ...
      <div class="cover-content-box">
        ...
        <div class="cover-main-title">Nhập, xuất dữ liệu trong python</div>
...
<div class="agenda-item-row"><span>2.</span> <span>hàm input()</span></div>
<div class="agenda-item-row"><span>3.</span> <span>hàm print()</span></div>
<div class="agenda-item-row"><span>4.</span> <span>f-string (Formatted String Literal)</span></div>
<div class="agenda-item-row"><span>5.</span> <span>Ghép chuỗi (String Concatenation)</span></div>
<div class="agenda-item-row"><span>6.</span> <span>Ép kiểu dữ liệu (Type Casting)</span></div>
      ...
      <div class="content-header-title">
        ...
        <div class="cards-container-row">
          <div class="card-column-box">
            ...
            <div class="inner-white-card"><h4>Trở Ngại Hệ Thống #1</h4><p>- **Đặt vấn đề thực tế**:</p></div>
<div class="inner-white-card"><h4>Trở Ngại Hệ Thống #2</h4><p>- Trong lập trình ứng dụng doanh nghiệp, một chương trình nếu chỉ hoạt động với các biến cố định được gán cứng (hardcoded) trong mã nguồn sẽ không có giá trị thực tiễn</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Giải Pháp & Cách Khắc Phục</div>
            <div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #1</h4><p>Hệ thống cần có khả năng tiếp nhận dữ liệu biến động từ người dùng và phản hồi kết quả tức thì</p></div>
<div class="inner-white-card"><h4>Hướng Xử Lý Triệt Để #2</h4><p>- Ví dụ: Trong phân hệ tính lương của doanh nghiệp, phần mềm cần nhận thông tin thực tế về số ngày công và hệ lương của từng nhân viên nhập vào từ phòng nhân sự, sau đó tính toán và hiển thị bảng lương chi tiết lên màn hình</p></div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="02. Bản Chất Kỹ Thuật: hàm input()">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        02. Bản Chất Kỹ Thuật: hàm input()
      </div>
        ...
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            ...
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Hàm mặc định của Python được sử dụng để nhận dữ liệu đầu vào từ người dùng qua bàn phím</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Giá trị trả về của hàm này luôn là kiểu chuỗi ký tự (str)</p></div>
                ...
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'hàm input()' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
                ...
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'hàm input()' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Nhập tên học viên từ bàn phím</span><br/>ten = input("Nhập tên của bạn: ")<br/><br/><span class="cm"># In lời chào mặc định ra màn hình</span><br/>print("Xin chào,", ten)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="03. Bản Chất Kỹ Thuật: hàm print()">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        03. Bản Chất Kỹ Thuật: hàm print()
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Hàm mặc định dùng để xuất dữ liệu ra màn hình</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Hàm hỗ trợ các tham số như 'sep' (ký tự ngăn cách các giá trị) và 'end' (ký tự kết thúc dòng, mặc định là xuống dòng \n)</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'hàm print()' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'hàm print()' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Khởi tạo biến thông tin</span><br/>ten_mon_hoc = "Python Core"<br/>thoi_luong = 30<br/><br/><span class="cm"># 1. Định dạng bằng f-string</span><br/>print(f"Khóa học: {ten_mon_hoc} - Thời lượng: {thoi_luong} giờ")<br/><br/><span class="cm"># 2. Ghép chuỗi bằng toán tử + (phải ép kiểu số sang chuỗi bằng str())</span><br/>thong_tin_ghep = "Khóa học: " + ten_mon_hoc + " - " + str(thoi_luong) + " giờ"<br/>print(thong_tin_ghep)<br/><br/><span class="cm"># 3. Sử dụng các tham số sep và end trong print</span><br/>print("Khóa", "học", sep="-", end=": ")<br/>print(ten_mon_hoc)
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="04. Bản Chất Kỹ Thuật: f-string (Formatted String Literal)">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        04. Bản Chất Kỹ Thuật: f-string (Formatted String Literal)
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Cú pháp định dạng chuỗi mạnh mẽ được ký hiệu bằng chữ 'f' hoặc 'F' đặt trước dấu nháy chuỗi, giúp chèn giá trị của biến hoặc biểu thức trực tiếp vào chuỗi thông qua cặp ngoặc nhọn {}</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'f-string (Formatted String Literal)' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'f-string (Formatted String Literal)' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
              <span class="cm"># Chương trình tương tác tính tuổi</span><br/>nam_hien_tai = 2024<br/><br/>nam_sinh_str = input("Nhập năm sinh của bạn: ")<br/><br/>try:<br/><span class="cm">    # Thực hiện ép kiểu từ chuỗi sang số nguyên</span><br/>    nam_sinh = int(nam_sinh_str)<br/>    <br/><span class="cm">    # Tính toán tuổi</span><br/>    tuoi = nam_hien_tai - nam_sinh<br/>    <br/><span class="cm">    # Kiểm tra tính logic của dữ liệu đầu vào</span><br/>    if tuoi &lt; 0:<br/>        print("Lỗi logic: Năm sinh không thể lớn hơn năm hiện tại!")<br/>    else:<br/><span class="cm">        # Xuất kết quả định dạng</span><br/>        print(f"Tuổi của bạn là: {tuoi} tuổi.")<br/>        <br/>except ValueError:<br/><span class="cm">    # Khắc phục lỗi khi người dùng nhập chữ thay vì nhập số</span><br/>    print("Lỗi đầu vào: Vui lòng chỉ nhập số nguyên hợp lệ cho năm sinh!")
            </div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="05. Bản Chất Kỹ Thuật: Ghép chuỗi (String Concatenation)">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        05. Bản Chất Kỹ Thuật: Ghép chuỗi (String Concatenation)
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Phép liên kết nhiều chuỗi ký tự thành một chuỗi duy nhất bằng toán tử cộng (+)</p></div><div class="inner-white-card" style="margin-bottom: 8px;"><p>Yêu cầu tất cả các thành phần tham gia phép ghép phải thuộc kiểu dữ liệu chuỗi (str)</p></div>
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="06. Bản Chất Kỹ Thuật: Ép kiểu dữ liệu (Type Casting)">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        06. Bản Chất Kỹ Thuật: Ép kiểu dữ liệu (Type Casting)
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Quá trình chuyển đổi giá trị từ kiểu dữ liệu này sang kiểu dữ liệu khác (ví dụ: chuyển từ chuỗi sang số nguyên bằng int() hoặc số thực bằng float()) để thực hiện các phép toán số học</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Ép kiểu dữ liệu (Type Casting)' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Ép kiểu dữ liệu (Type Casting)' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="07. Bản Chất Kỹ Thuật: Lỗi TypeError">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        07. Bản Chất Kỹ Thuật: Lỗi TypeError
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Lỗi xảy ra khi áp dụng một thao tác hoặc hàm lên một đối tượng có kiểu dữ liệu không tương thích (ví dụ: thực hiện phép cộng giữa chuỗi và số nguyên mà không ép kiểu trước)</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Lỗi TypeError' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Lỗi TypeError' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
    ...
    <div class="slide slide-content-layout" data-type="content" data-title="08. Bản Chất Kỹ Thuật: Lỗi ValueError">
      <div class="content-top-accent-bar"></div>
      <img src="https://rikkei.edu.vn/wp-content/uploads/2025/09/Logo.png" alt="Logo" class="top-right-logo" />
      <div class="content-header-title">
        08. Bản Chất Kỹ Thuật: Lỗi ValueError
      </div>
      
        <div class="cards-container-row">
          <div class="card-column-box" style="background: #ffffff; border: 1px solid #e2e8f0; padding: 20px;">
            <h3 style="font-size: 20px; font-weight: 800; margin-bottom: 12px; color: var(--brand-red);">Khái niệm &amp; Phân tích</h3>
            <div class="inner-white-card" style="margin-bottom: 8px;"><p>Lỗi xảy ra khi thực hiện ép kiểu dữ liệu với giá trị không phù hợp (ví dụ: chuyển đổi chuỗi chứa ký tự chữ sang kiểu số nguyên bằng int())</p></div>
            
                <div style="background: #fffbeb; border: 1.5px solid #f59e0b; border-radius: 8px; padding: 8px 12px; margin-top: 8px; color: #92400e; font-size: 13px;">
                  <strong style="color: #d97706;">💡 Mẹo Giảng Dạy &amp; Trick:</strong> Nhấn mạnh cơ chế hoạt động thực tế của 'Lỗi ValueError' giúp tối ưu hiệu năng và hạn chế lỗi tại runtime.
                </div>
            
                <div style="background: #eff6ff; border: 1.5px solid #3b82f6; border-radius: 8px; padding: 8px 12px; margin-top: 6px; color: #1e40af; font-size: 13px;">
                  <strong style="color: #2563eb;">🏢 Bối Cảnh Thực Tế:</strong> Áp dụng 'Lỗi ValueError' trong module xử lý nghiệp vụ của hệ thống doanh nghiệp thực tế.
                </div>
          </div>
          <div class="card-column-box" style="background: transparent; padding: 0; display: flex; flex-direction: column;">
            <div class="academic-code-box">
      ...
      <div class="content-header-title">
        ...
        <div class="cards-container-row">
          <div class="card-column-box">
            ...
            <div class="inner-white-card"><h4>Điểm Cốt Lõi #1</h4><p>- **Lưu ý và Cảnh báo lỗi Thời gian chạy (Runtime Mistakes)**:</p></div>
<div class="inner-white-card"><h4>Điểm Cốt Lõi #2</h4><p>- Phải ghi nhớ rằng đầu ra của hàm `input()` luôn luôn mang kiểu dữ liệu chuỗi ký tự (`str`)</p></div>

          </div>
          <div class="card-column-box">
            <div class="column-title" style="color: var(--brand-dark);">Sai Lầm Cần Tránh</div>
            <div class="inner-white-card"><h4>Lưu Ý Thực Chiến #1</h4><p>Cố gắng thực hiện các phép tính số học trên kiểu chuỗi sẽ làm phát sinh ngoại lệ **TypeError**</p></div>
<div class="inner-white-card"><h4>Lưu Ý Thực Chiến #2</h4><p>- Hãy cẩn trọng khi thực hiện ép kiểu thủ công: Nếu giá trị người dùng nhập vào không thể lượng hóa thành số (ví dụ nhập chữ cái `abc` trong khi thực hiện ép kiểu `int()`), trình biên dịch sẽ ném ra lỗi **ValueError** và dừng chương trình đột ngột</p></div>
        ...
        <div class="timeline-nodes-grid">
          ...
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              ...
              <p>- **Đặt vấn đề thực tế**:
  - Trong lập trình ứng dụng doanh nghiệp, một chương trình nếu ...</p>
            </div>
          ...
          <div class="timeline-node">
            ...
            <div class="node-card" style="margin-top: 24px;">
              <h5>2. hàm input()</h5>
              <p>Hàm mặc định của Python được sử dụng để nhận dữ liệu đầu vào từ người dùng qua bàn phím. G...</p>
            </div>
          </div>
          <div class="timeline-node">
            <div class="node-card" style="margin-bottom: 24px;">
              <h5>3. hàm print()</h5>
              <p>Hàm mặc định dùng để xuất dữ liệu ra màn hình. Hàm hỗ trợ các tham số như 'sep' (ký tự ngă...</p>
            </div>
            <div class="timeline-dot"></div>
          </div>
          <div class="timeline-node">
            <div class="timeline-dot" style="margin-top: 60px;"></div>
            <div class="node-card" style="margin-top: 24px;">
              <h5>4. f-string (Formatted String Literal)</h5>
              <p>Cú pháp định dạng chuỗi mạnh mẽ được ký hiệu bằng chữ 'f' hoặc 'F' đặt trước dấu nháy chuỗ...</p>
            </div>
          </div>
        </div>
      </div>
