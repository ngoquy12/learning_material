...
# Tổng kết & Luyện tập
- Bài học cốt lõi: Lưu ý quan trọng cho **Giới thiệu ngôn ngữ Python**: Luôn ép kiểu rõ ràng khi nhận dữ liệu từ `input()`. Lỗi thường gặp nhất là quên f ở đầu f-string làm tên biến không được thế giá trị.
