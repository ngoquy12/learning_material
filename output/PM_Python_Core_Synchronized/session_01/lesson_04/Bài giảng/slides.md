...
# Tổng kết & Luyện tập
- Bài học cốt lõi: Lưu ý quan trọng cho **Kiểu dữ liệu cơ bản**: Luôn ép kiểu rõ ràng khi nhận dữ liệu từ `input()`. Lỗi thường gặp nhất là quên f ở đầu f-string làm tên biến không được thế giá trị.
