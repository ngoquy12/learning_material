...
### Câu 4 (Phân tích lỗi thường gặp & Trường hợp biên): Nếu nhập `score = -1.0` hoặc `score = 11.0`, hãy chỉ ra điểm bất hợp lý của mã nguồn hiện tại và đề xuất cách cải tiến.
> **Gợi ý trả lời & Định hướng đáp án:**
