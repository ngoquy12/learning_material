...
3. 2D FLAT VECTOR SCENE IMAGE STANDARD (SECTION 1 - PROBLEM STATEMENT):
   ...
   - WIDE 16:9 HORIZONTAL LANDSCAPE DIRECTIVE: All scene images MUST be generated in wide 16:9 horizontal widescreen landscape format (aspect ratio 16:9, wide horizontal orientation, left-to-right flow) to ensure compact height and optimal viewing on reading articles.
